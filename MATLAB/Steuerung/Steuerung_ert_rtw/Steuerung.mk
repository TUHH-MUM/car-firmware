###########################################################################
## Makefile generated for Simulink model 'Steuerung'. 
## 
## Makefile     : Steuerung.mk
## Generated on : Thu Oct 25 19:17:17 2018
## MATLAB Coder version: 4.0 (R2018a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Steuerung.elf
...
MODELREF_LINK_RSPFILE_NAME = Steuerung_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Steuerung.elf
...
DEFINES_STANDARD = -DMODEL=Steuerung -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = v4l2_capture.c v4l2_capture_linux.c hough_d_rt.c hough_r_rt.c Steuerung.c Steuerung_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c ext_svr.c updown.c ext_work.c rtiostream_utils.c MCU6050_wrapper.c PCA6585_wrapper.c PCF8591_wrapper.c RPI_Init_wrapper.c linuxinitialize.c rtiostream_interface.c rtiostream_tcpip.c
...
OBJS = v4l2_capture.c.o v4l2_capture_linux.c.o hough_d_rt.c.o hough_r_rt.c.o Steuerung.c.o Steuerung_data.c.o rtGetInf.c.o rtGetNaN.c.o rt_nonfinite.c.o ext_svr.c.o updown.c.o ext_work.c.o rtiostream_utils.c.o MCU6050_wrapper.c.o PCA6585_wrapper.c.o PCF8591_wrapper.c.o RPI_Init_wrapper.c.o linuxinitialize.c.o rtiostream_interface.c.o rtiostream_tcpip.c.o
