 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Oct 25 19:12:08 2018
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME MCU6050
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
{
    int16_T *ax = (int16_T *) ssGetOutputPortRealSignal(S, 0);
    int16_T *ay = (int16_T *) ssGetOutputPortRealSignal(S, 1);
    int16_T *az = (int16_T *) ssGetOutputPortRealSignal(S, 2);
    int16_T *omx = (int16_T *) ssGetOutputPortRealSignal(S, 3);
    int16_T *omy = (int16_T *) ssGetOutputPortRealSignal(S, 4);
    int16_T *omz = (int16_T *) ssGetOutputPortRealSignal(S, 5);
    int16_T *temp = (int16_T *) ssGetOutputPortRealSignal(S, 6);
    const real_T *xD = ssGetDiscStates(S);

    MCU6050_Outputs_wrapper(ax, ay, az, omx, omy, omz, temp, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    MCU6050_Update_wrapper(ax, ay, az, omx, omy, omz, temp, xD);
