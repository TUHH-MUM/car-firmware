 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Oct 25 19:12:02 2018
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PCF8591
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       PCF8591_out
...
{
    uint8_T *PCF8591_out = (uint8_T *) ssGetOutputPortRealSignal(S, 0);
    const real_T *xD = ssGetDiscStates(S);

    PCF8591_Outputs_wrapper(PCF8591_out, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    PCF8591_Update_wrapper(PCF8591_out, xD);
