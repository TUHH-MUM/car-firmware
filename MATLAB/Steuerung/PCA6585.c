 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Thu Oct 25 19:12:27 2018
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME PCA6585
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS            4
/* Input Port  0 */
#define IN_PORT_0_NAME        IN_1
...
{
    const boolean_T *IN_1 = (boolean_T *) ssGetInputPortRealSignal(S, 0);
    const boolean_T *IN_2 = (boolean_T *) ssGetInputPortRealSignal(S, 1);
    const uint16_T *PWM = (uint16_T *) ssGetInputPortRealSignal(S, 2);
    const uint16_T *SERVO = (uint16_T *) ssGetInputPortRealSignal(S, 3);
    const real_T *xD = ssGetDiscStates(S);

    PCA6585_Outputs_wrapper(IN_1, IN_2, PWM, SERVO, xD);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    PCA6585_Update_wrapper(IN_1, IN_2, PWM, SERVO, xD);
